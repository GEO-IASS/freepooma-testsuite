...
int main(int argc, char *argv[])
{
  ...
  try {
    ...
    AC(2) = -999;
    tester.out() << "AC(2) = " << AC(2) << std::endl;
    tester.out() << "A(2) = " << A(2) << std::endl;
...
#endif    
  int ret = tester.results("brick_test2");
  Pooma::finalize();
  return ret;
}
...
// ACL:rcsinfo
// ----------------------------------------------------------------------
// $RCSfile: brick_test2.cpp,v $   $Author: richard $
// $Revision: 1.15 $   $Date: 2004/11/01 18:16:38 $
// ----------------------------------------------------------------------
// ACL:rcsinfo
