...
//
//-----------------------------------------------------------------------------
// Particle test 1: SpatialLayout, MP Dynamic Attrib, URM + MP Brick Field
//-----------------------------------------------------------------------------
...
int main(int argc, char *argv[])
{
  ...
  startParticleTest(argc, argv, "SpatialLayout: A=MPDynamic, F=URM+MPBrick");
  ...
  return endParticleTest("SpatialLayout: A=MPDynamic, F=URM+MPBrick");
}

// ACL:rcsinfo
// ----------------------------------------------------------------------
// $RCSfile: particle_test1.cpp,v $   $Author: richard $
