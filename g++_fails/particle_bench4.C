...
//
//-----------------------------------------------------------------------------
// Particle bench 4: SpatialLayout, MP(Dynamic) Attrib, RM+MP(G,Brick) Field
//-----------------------------------------------------------------------------
...
int main(int argc, char *argv[])
{
  ...
  startParticleTest(argc, argv,
    "SpatialLayout Benchmark: A=MP(Dynamic), F=RM+MP(Grid,Brick)");
...
// ACL:rcsinfo
// ----------------------------------------------------------------------
// $RCSfile: particle_bench4.cpp,v $   $Author: richard $
