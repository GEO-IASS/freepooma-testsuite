...
#ifndef POOMA_PARTICLES_REFLECTBC_H
#define POOMA_PARTICLES_REFLECTBC_H
 ...
 * ReflectBC sets value to be inside boundary by that amount.
 */
...
template <class T>
class ReflectBC : public ParticleBCType< ReflectBC<T> >
{
public:
...
public:
  ...
  void print(std::ostream& o) const
    {
      o << "BC Type: Reflect, Range: (" << bc_m.min()
        << "," << bc_m.max() << ")" << std::endl;
    }
...
#endif     // POOMA_PARTICLES_REFLECTBC_H

// ACL:rcsinfo
// ----------------------------------------------------------------------
// $RCSfile: ReflectBC.h,v $   $Author: richard $
